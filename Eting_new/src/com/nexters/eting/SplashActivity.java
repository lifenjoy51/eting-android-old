...
public class SplashActivity extends Activity {
	...
	//TODO 임시로 true로
	private boolean isLoaded= true;	//캐쉬 로딩 여부
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if(Util.isEmpty(deviceId)){
			//기기등록 고고씽
			new RegistrationTask().execute(gcmInitService.regId, context);
		}
		
		//GCM 등록 실패시
		if(!gcmInitService.isReg){
	...
	private void moveToLockScreenActivity() {
		...
		boolean isPassword = pref.getBoolean("isPassword", false);
		Class<?> targetClass;
