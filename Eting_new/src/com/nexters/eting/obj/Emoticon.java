...
public class Emoticon {
	...
	private static void init() {
		...
		emoticon_press_map.put("2", R.drawable.emotion_icon02_press);
		emoticon_press_map.put("3", R.drawable.emotion_icon03_press);
		emoticon_press_map.put("4", R.drawable.emotion_icon04_press);
		emoticon_press_map.put("5", R.drawable.emotion_icon05_press);
		emoticon_press_map.put("6", R.drawable.emotion_icon06_press);
	}
